...
# Also someone should update the libs/mqtt_remote_method_calls.py file on the robot too (at some point before Bill).
...
def left_mouse_click(event, mqtt_client):
    ...
    my_color = "light pink"  # Make your color unique
