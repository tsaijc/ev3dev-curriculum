...
def control_ev3_movements():
    ...
    # left_speed_entry = ttk.Radiobutton(main_frame, text='100', value=100)
    # left_speed_entry.grid(row=1, column=0)
    # left_speed_entry = ttk.Radiobutton(main_frame, text='200', value=200)
    # left_speed_entry.grid(row=2, column=0)
    # left_speed_entry = ttk.Radiobutton(main_frame, text='300', value=300)
    # left_speed_entry.grid(row=3, column=0)
    # left_speed_entry = ttk.Radiobutton(main_frame, text='400', value=400)
    # left_speed_entry.grid(row=4, column=0)
    # left_speed_entry = ttk.Radiobutton(main_frame, text='500', value=500)
    # left_speed_entry.grid(row=5, column=0)
    # left_speed_entry = ttk.Radiobutton(main_frame, text='600', value=600)
    # left_speed_entry.grid(row=6, column=0)
    # left_speed_entry = ttk.Radiobutton(main_frame, text='700', value=700)
    # left_speed_entry.grid(row=7, column=0)
    # left_speed_entry = ttk.Radiobutton(main_frame, text='800', value=800)
    # left_speed_entry.grid(row=8, column=0)
    # left_speed_entry = ttk.Radiobutton(main_frame, text='900', value=900)
    ...
    # right_speed_entry = ttk.Radiobutton(main_frame, text='100', value=100)
    # right_speed_entry.grid(row=1, column=2)
    # right_speed_entry = ttk.Radiobutton(main_frame, text='200', value=200)
    # right_speed_entry.grid(row=2, column=2)
    # right_speed_entry = ttk.Radiobutton(main_frame, text='300', value=300)
    # right_speed_entry.grid(row=3, column=2)
    # right_speed_entry = ttk.Radiobutton(main_frame, text='400', value=400)
    # right_speed_entry.grid(row=4, column=2)
    # right_speed_entry = ttk.Radiobutton(main_frame, text='500', value=500)
    # right_speed_entry.grid(row=5, column=2)
    # right_speed_entry = ttk.Radiobutton(main_frame, text='600', value=600)
    # right_speed_entry.grid(row=6, column=2)
    # right_speed_entry = ttk.Radiobutton(main_frame, text='700', value=700)
    # right_speed_entry.grid(row=7, column=2)
    # right_speed_entry = ttk.Radiobutton(main_frame, text='800', value=800)
    # right_speed_entry.grid(row=8, column=2)
    # right_speed_entry = ttk.Radiobutton(main_frame, text='900', value=900)
